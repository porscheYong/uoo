                        ...
                        "<div id='conDiv_"+gCount+"' class='conDiv'>"+
                            "<div class='dataCondition' id='con_"+cCount+"'>"+
                                ...
                                "<div class='row' style='margin-bottom: 10px;'>"+
                                    ...
                                    "<div class='col-md-6 col-sm-6 col-xs-6'>"+
                                        "<div style='width: 100%'>"+
                                            "<label for='colValue_"+cCount+"' class='col-md-4 col-sm-4 col-xs-4' style='padding-right: 20px;line-height: 40px;text-align: right;'>字段值</label>"+
                                            "<input id='colValue_"+cCount+"' style='padding:8px 8px' class='ui-input col-md-8 col-sm-8 col-xs-8' size='40'>"+
                                        "</div>"+
                                    "</div>"+
                                "</div>"+
                            "</div>"+
