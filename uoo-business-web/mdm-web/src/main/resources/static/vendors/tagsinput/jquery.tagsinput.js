...
(function($) {
        ...
        this.each(function() {
            ...
            if (value !='' && skipTag != true) {
                for (var i = 0; i < value.length; i++) {
                    var name = value[i].name || value[i].locName || value[i].orgTypeName || value[i].refName || value[i].positionName || value[i].postName || value[i].roleName;
    ...
    $.fn.tagsInput.importTags = function(obj, tagslist, options) {
        options = jQuery.extend({focus:false,callback:true},options);
        $(obj).addTag(tagslist,options);
    };
