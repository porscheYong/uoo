...
public class StrUtil {
	 ...
	 * 号码段配置信息
	 */
	// private static NumberSegmentManager numberSegmentManager =
	// (NumberSegmentManager)
	// ApplicationContextUtil.getBean("numberSegmentManager");
	/**
	 * 如果是null转换成""
	 * 
	 * @author 曾臻
	...
	public static String filterRn(String htmlStr) {
		String textStr = "";
		java.util.regex.Pattern p_rn;
		java.util.regex.Matcher m_rn;
		try {
			String regEx_rn = "[\\r\\n]*";
	...
	public static String getLimitLengthString(String str, int len, String symbol) {
		...
		try {
			...
			for (int kk = 0; (kk < tempChar.length && reInt < len - symbol.length()); kk++) {
	 ...
	 * 3G业务专属的180-189
	 * 号段已基本分配给各运营商使用,其中180、181、189分配给中国电信,187、188归中国移动使用,185、186属于新联通。
	 * 中国移动拥有号码段
	...
	public static boolean checkTelephoneNumber(String telephoneNumber) {
		 ...
		 * Matcher m = p.matcher(telephoneNumber); return m.matches();
		 */
		...
		if (m.matches()) {
			/*
			 * List<NumberSegment> list =
			 * numberSegmentManager.findAllByActive(); for(NumberSegment ns :
			 * list){ if(telephoneNumber.startsWith(ns.getNumberSegment())){
			 * return true; } }
			 */
			return true;
		}
	...
	/**
	 * 校验手机号是否属于电信手机，是则返回true，不是则返回false
	 * xiangy
	 * 2019-03-05
	 *
	 */
	public static boolean checkTelecomphoneNumber(String telephoneNumber) {		
		//电信网段：133、149、153、173、174、177、180、181、189、191、199
		//虚拟网段：1700、1701、1702 （1349、1410、1700、1701、1702、1740）
		//133、153、177、180、181、189、191、199、1349、1410、1700、1701、1702、1740
		//133 149 153 173 174 177 180 181 189  191  199
		Pattern p = Pattern.compile("(^1(33|53|77|73|74|8[019]|49|91|99)\\d{8}$)|(^170[0-2]\\d{7}$)"); 
