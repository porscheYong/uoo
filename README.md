# 用户组织运营平台
## 项目简介
uoo是采用Spring Cloud微服务化开发平台，具有统一授权、认证后台管理系统，也可以作为后端服务的开发脚手架。代码要求简洁、架构清晰，适合对微服务学习和直接项目中使用。核心技术采用Spring Boot 1.5.15.RELEASE以及Spring Cloud (Edgware.SR4)相关核心组件，当下前端采用Thymeleaf的HTML来开发的，后续准备采用VUE进行二次改造。
...
- business-auth 认证鉴权所用的业务，可对认证管理WEB提供服务
...
| 1 | MyBatis | 3.4.6 |
| 2 | JAP | Edgware.SR4 |
| 3 | Hibernate Validation | Edgware.SR4 |
...
|   |   |——api-auth---------------------------------------认证SSO对外API
|   |   |   |
|   |   |   |——api-auth-cs--------------------------------提供CS认证服务
|   |   |   |
|   |   |   |——api-auth-bs--------------------------------提供BS认证服务
|   |
...
| 118 | business-auth | 认证管理 | 11800、11811、11822 |
...
| 202 | api-auth-cs | 用户域服务API-CS | 20200、20211、20222 |
| 203 | api-auth-bs | 用户域服务API-BS | 20300、20311、20322 |
...
| 118 | business-auth | 认证管理 | 11800、11811、11822、11833、11844 |
...
| 202 | api-auth-cs | 用户域服务API-CS | 20200、20211、20222、20233、20244 |
| 203 | api-auth-bs | 用户域服务API-BS | 20300、20311、20322、20333、20344 |
