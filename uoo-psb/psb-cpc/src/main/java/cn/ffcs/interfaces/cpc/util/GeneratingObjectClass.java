...
public class GeneratingObjectClass {
    public static String scDir = "cn.ffcs.interfaces.cpc";
    public static String scXmlDir = "src.main.resources";
    public static String authorName = "lxd";
...
//    ,"TB_POST2","TB_ORG_POST_REL"};
    public static String[] tabeNamesList = {"TB_ORG"};
