...
/**
 *
 * 使用方法:调用 IDCardUtil.IDCardValidate(str)验证是否为合法的身份证.返回的是一个String, "1" 代表合法的身份证
 * ,其他值代表错误信息
 *
 * @author shen
 *
...
public class IDCardUtil {
     ...
     * @return
     */
    public static String getGender(String certNumber){
        if (certNumber.length() == 15) {
            return (Integer.parseInt(certNumber
                    .substring(14, 15)) % 2 == 0 ? "2" : "1");

        } else if (certNumber.length() == 18) {
            return (Integer.parseInt(certNumber
                    .substring(16, 17)) % 2 == 0 ? "2" : "1");
        }
        return "1";
    }
...
//    }
    ...
    public static void main(String[] args) {
        System.out.println(IDCardUtil.IDCardValidate("350104199212154493"));
    }
