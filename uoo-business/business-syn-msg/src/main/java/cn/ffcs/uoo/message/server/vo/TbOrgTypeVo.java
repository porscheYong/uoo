...
public class TbOrgTypeVo {
    ...
    private String supPkOrgTypeName;
    ...
    public String getSupPkOrgTypeName() {
        return supPkOrgTypeName;
    }

    public void setSupPkOrgTypeName(String supPkOrgTypeName) {
        this.supPkOrgTypeName = supPkOrgTypeName;
    }
}
