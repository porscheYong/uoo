...
public interface OrgTypeMapper extends BaseMapper<OrgType> {
    ...
    public List<TreeNodeVo> selectOrgTypeTree(@Param("supOrgTypeId")String supOrgTypeId,
                                              @Param("orgTypeCode")String orgTypeCode,
                                              @Param("orgTypeParams")String orgTypeParams);

    public List<TreeNodeVo> selectFullOrgTypeTreeByOrgId(@Param("orgTypeId")String orgTypeId,
                                                         @Param("orgTypeCode")String orgTypeCode,
