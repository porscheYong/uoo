package cn.ffcs.uoo.core.position.generator;
 ...
 */
public class OracleGeneratorPosition {

    /**文件路径
     *
     */
    private static String packageName="position";

    private static String localhostUrl="C:\\dev_code\\uoo\\uoo-core\\uoo-position";
     ...
     *
     */
    private static String table="tb_org_position_rel";
    /**table前缀
     *
     */
