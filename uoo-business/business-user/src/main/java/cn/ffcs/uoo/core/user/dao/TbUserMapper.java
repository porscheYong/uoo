...
public interface TbUserMapper extends BaseMapper<TbUser> {
    ...
    // todo ----新版本------------------------------------------------------------------------
    public List<ListUserVo> getUserList(@Param("personnelId") Long personnelId);

    public PersonnelInfoVo getPersonnelInfo(@Param("personnelId") Long personnelId);

    public List<ListAcctOrgVo> getAcctOrg(Pagination page, @Param("acctOrgVo") ListAcctOrgVo acctOrgVo);
