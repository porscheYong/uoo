...
public class BusinessSystemController {
    ...
    @UooLog(value = "接入系统列表", key = "listBusinessSystem")
    ...
    public ResponseResult<List<BusinessSystem>> listBusinessSystemByOrgTree(@PathVariable(value = "treeId")  Long treeId){
        List<BusinessSystem> listBusinessSystemByOrgTree = bizSysSvc.listBusinessSystemByOrgTree(treeId);
        return ResponseResult.createSuccessResult(listBusinessSystemByOrgTree, "");
    }
}
