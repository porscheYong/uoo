 ...
 * @since 2018-09-25
 */
@TableName("TB_ORG_REF_TYPE")
public class OrgRefType extends Model<OrgRefType> {
     ...
     * 关系类型标识
     */
    @TableId(value = "ORG_REF_TYPE_ID", type = IdType.AUTO)
     ...
     * 上级关系类型标识
     */
    @TableField("SUP_ORG_REF_TYPE_ID")
    ...
    public String toString() {
        ...
        ", refName=" + refName +
        ", refCode=" + refCode +
        ", supOrgRefTypeId=" + supOrgRefTypeId +
        ", statusCd=" + statusCd +
